...
class PinListWrapper(LEF_Parameters):
    def __init__(self, mem):
        ...
        self.r_addr_in_section_start        = 0.15
        self.r_addr_in_section_end          = 0.25
        self.w_addr_in_metal_layer          = self.metLayerVerticalPin
        self.w_addr_in_side                 = "right"
        self.w_addr_in_section_start        = 0.15
        self.w_addr_in_section_end          = 0.25
        ...
        self.is_r_port_and_rw_port = True if (self.num_rports > 0 and self.num_rwports > 0) else False
        self.is_r_port_or_rw_port = True if (self.num_rports > 0 or self.num_rwports > 0) else False
        self.is_r_port_or_w_port = True if (self.num_rports > 0 or self.num_rwports > 0 or self.num_wports > 0) else False 
        self.is_r_port_and_w_port = True if (self.num_rports > 0 and self.num_wports > 0) or self.num_rwports > 0 else False 

#### Private Functions
#---------------------
    def _validate_generated_pin_list(self
                        , pin_list :  list
                        , num_pins :  int
                        , start    :  float = None
                        , end      :  float = None ) -> None:  
