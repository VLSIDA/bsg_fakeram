...
from utils.mem_init.mem_area import get_macro_dimensions
...
class CustomData():
    def __init__(self, custom_data):
        if custom_data is not None:
            self.hybrid                      = custom_data.get('hybrid', False)
            ...
            self.transistor_architecture     = None
            self.access_time_ns              = 0.0
            self.cycle_time_ns               = 0.0
            self.fo4_ps                      = 0.0
            self.standby_leakage_per_bank_mW = 0.0
            self.pin_dynamic_power_mW        = 0.0
            self.finPitch_nm                 = 0.0
            self.contacted_poly_pitch_nm     = 0.0
            self.h0_tracks                   = 0.0
            self.w0_polys                    = 0.0
            self.dh_read                     = 0.0
            self.dw_read                     = 0.0
